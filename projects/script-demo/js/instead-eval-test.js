...
//let countOfMultiply = operators.filter((element) => "*" === element).length;
//console.log(`곱하기 연산자 갯수 : ${countOfMultiply}`);

const division = operators.indexOf("/");
//let countOfDivision = operators.filter((element) => "/" === element).length;
//console.log(`나누기 연산자 갯수 : ${countOfDivision}`);

const add = operators.indexOf("+");
//let countOfAdd = operators.filter((element) => "+" === element).length;
//console.log(`더하기 연산자 갯수 : ${countOfAdd}`);

const subtraction = operators.indexOf("-");
//let countOfSubtraction = operators.filter((element) => "-" === element).length;
//console.log(`나누기 연산자 갯수 : ${countOfSubtraction}`);
